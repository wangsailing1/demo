...
class ScriptGroup(ModelBase):
    ...
    def add_script_group(self,script_id,next_id,big_sale,output):
        ...
        if next_id > self.group[group_id]['next_id']:
            self.group[group_id]['next_id'] = next_id
        if big_sale:
...
ModelManager.register_model('script_group', ScriptGroup)
