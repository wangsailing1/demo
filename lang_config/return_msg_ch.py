...
friend_msg = {
    ...
    'friend.unlock_section': {
        1: u'请先前往上一个约会地点',
        2: u'解锁的约会地点错误',
        3: u'第一次约会地点无需解锁',
        4: u'已经可以前往约会地点了',
    },
    'friend.delete_rapport_log': {
        1: u'参数错误',
        2: u'无此约会',
        11: u'约会地点错误',
        12: u'未进行过此对话',
...
i18n = {
    ...
    'king_of_song_close': u'每月{}-{}日开始节目，敬请期待！',
