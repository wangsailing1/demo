...
# master配置
master = {'host': '10.10.4.10', 'port': 6401, 'socket_timeout': 5, 'db': 0, 'password': 'ga00qHZEj8uvTu62jz40'}
# 公共配置
public = {'host': '10.10.4.10', 'port': 6401, 'socket_timeout': 5, 'db': 1, 'password': 'ga00qHZEj8uvTu62jz40'}
# 聊天
chat_config = {'host': '10.10.4.10', 'port': 6401, 'socket_timeout': 5, 'db': 2, 'password': 'ga00qHZEj8uvTu62jz40'}
# celery
celery_config = {'host': '10.10.4.10', 'port': 6401, 'socket_timeout': 5, 'db': 2, 'password': 'ga00qHZEj8uvTu62jz40'}

# 每个app配置
apps = [
    # server, long_net_name, redis_ip, redis_port, redis_db, father_server
    ('twd1', 'net1', '10.10.4.10', 6401, 3),
    ('twd2', 'net1', '10.10.4.10', 6401, 3),
    ('twd3', 'net1', '10.10.4.10', 6401, 3),
    ('twd4', 'net1', '10.10.4.10', 6401, 3),
    ('twd5', 'net1', '10.10.4.10', 6401, 3),
]
