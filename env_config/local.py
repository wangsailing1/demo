...
SLG_REDIS_DEFAULT = {'host': '127.0.0.1', 'port': 7200, 'socket_timeout': 5, 'db': 15, 'password': ''}
SLG_REQUESTRUN = {
    # slg_server_id: redis_config
    # 同 <redis ip = "127.0.0.1" port = "7200" password = "" timeout = "1" select_db = "7"/>
...
# master配置
master = {'host': '127.0.0.1', 'port': 7200, 'socket_timeout': 5, 'db': 15, 'password': ''}
# 公共配置
public = {'host': '127.0.0.1', 'port': 7200, 'socket_timeout': 5, 'db': 14, 'password': ''}
# 聊天
chat_config = {'host': '127.0.0.1', 'port': 7200, 'socket_timeout': 5, 'db': 14, 'password': ''}
# celery
celery_config = {'host': '127.0.0.1', 'port': 7200, 'socket_timeout': 5, 'db': 14, 'password': ''}

# 每个app配置
apps = [
    # server, long_net_name, redis_ip, redis_port, redis_db, father_server
    # 传给前端的各个区服连接对应的net节点,与netsettings里的匹配
    ('h1', 'net1', '127.0.0.1', 7200, 3),
    ('h2', 'net1', '127.0.0.1', 7200, 3),
    ('h3', 'net1', '127.0.0.1', 7200, 3),
    ('h4', 'net1', '127.0.0.1', 7200, 3),
    ('h5', 'net1', '127.0.0.1', 7200, 3),
]
