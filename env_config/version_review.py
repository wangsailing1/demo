...
PLATFORM = 'version_review'    # 平台标示
URL_PARTITION = 'big_sale'
MASTER_HOST = '10.0.2.18'
IN_MASTER_HOST = '10.0.2.18'          # 内网地址 备份用
# CHAT_HOST = '192.168.1.9'
# CHAT_IDS = [('192.168.1.9', 9079)]
CHAT_IDS = [('10.0.2.18', 9999)]

LANGUAGE = 'ch'
CDN = 'banshu-bigsale.hi365.com'
...
# master配置
master = {'host': '10.0.2.18', 'port': 6301, 'socket_timeout': 5, 'db': 0, 'password': 'ElpwyZKKmF8QTKTCW1D2'}
# 公共配置
public = {'host': '10.0.2.18', 'port': 6301, 'socket_timeout': 5, 'db': 1, 'password': 'ElpwyZKKmF8QTKTCW1D2'}
# 聊天
chat_config = {'host': '10.0.2.18', 'port': 6301, 'socket_timeout': 5, 'db': 2, 'password': 'ElpwyZKKmF8QTKTCW1D2'}
# celery
celery_config = {'host': '10.0.2.18', 'port': 6301, 'socket_timeout': 5, 'db': 14, 'password': 'ElpwyZKKmF8QTKTCW1D2'}

# 每个app配置
apps = [
    # server, long_net_name, redis_ip, redis_port, redis_db, father_server
    ('vr1', 'net1', '10.0.2.18', 6302, 3),
    ('vr2', 'net1', '10.0.2.18', 6302, 3),
]
...
for k, i in enumerate(apps):
    ...
    SERVERS[i[0]] = {
        ...
        'server': 'http://%s/%s/' % (MASTER_HOST, URL_PARTITION),
        'redis': {'host': i[2], 'port': i[3], 'socket_timeout': 5, 'db': i[4], 'password': 'ElpwyZKKmF8QTKTCW1D2'},
